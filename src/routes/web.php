...
Route::middleware('auth:admin')->prefix('admin')->group(function () {
    ...
    Route::get('/dashboard/getdata', [AdminController::class, 'getData']);
...
// เพิ่มหน้าสำหรับสแกน QR Code เพื่อดาวน์โหลดรูปภาพ
Route::get('/share', [App\Http\Controllers\GameController::class, 'sharePage'])->name('game.share');

Route::get('/api/all-challenges', [App\Http\Controllers\GameController::class, 'getAllChallenges']);
