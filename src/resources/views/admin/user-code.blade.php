    ...
    <div class="search-section">
        <form action="{{ route('admin.user-code') }}" method="GET" class="search-form">
            ...
            <div class="search-box">
                <input type="text" name="search" class="search-input" placeholder="ค้นหา..."
        ...
        <div class="table-responsive">
            <table class="custom-table">
                ...
                <thead>
                    <tr>
                        <th width="5%">No.</th>
                        <th width="15%">User Name</th> {{-- ✅ เพิ่มคอลัมน์ User Name --}}
                        <th width="40%" class="th-multiline">
                            Sort Code
                            <span>(Command, Time)</span>
                        </th>
                        <th width="30%" class="th-multiline">
                            Sort Code
                ...
                <tbody>
                    @foreach ($userCodes as $code)
                        <tr>
                            ...
                            {{-- ✅ แสดงชื่อผู้เล่นที่ดึงมาจาก Controller --}}
