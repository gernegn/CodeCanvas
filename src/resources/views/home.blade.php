    ...
    <div class="container">
        ...
        <div class="sec-content">
            <div class="box-content-main">
                <div class="box-board">
                    <img src="{{ asset('img/elements-frontend/board-random.png') }}" alt="Board"
                        class="main-board-bg" />

                    {{-- ✅ สร้างกล่องสำหรับจำกัดพื้นที่เฉพาะ "หน้ากระดาษวาดรูป" --}}
                    <div class="canvas-draw-area">
                        <img src="{{ asset('img/result-image/worm-green-dot.png') }}" alt="Worm"
                            class="drawn-item worm-center" />
                        <img src="{{ asset('img/result-image/heart-red.png') }}" alt="Heart"
                            class="drawn-item heart-top-left" />
                        <img src="{{ asset('img/result-image/heart-red.png') }}" alt="Heart"
                            class="drawn-item heart-top-right" />
                        <img src="{{ asset('img/result-image/heart-red.png') }}" alt="Heart"
                            class="drawn-item heart-mid-left" />
                    </div>
                </div>
